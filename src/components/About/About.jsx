        ...
        <div class="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
            <div class="flex flex-wrap ">
                    ...
                    <div class="relative lg:max-w-md">
                        ...
                        <div
                            ...
                            <p class="text-lg font-semibold md:w-72">
                                ...
                                </svg> We've designed our app with you in mind. 
                            </p>
                        </div>
                    </div>
                </div>
                <div class="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                    ...
                    Welcome to User, where productivity meets simplicity. We understand the challenges of managing tasks and staying organized in today's fast-paced world. That's why we've created a powerful yet user-friendly task management solution to help individuals and teams achieve their goals effortlessly.
                    </p>
                    <Link to="/contact"
